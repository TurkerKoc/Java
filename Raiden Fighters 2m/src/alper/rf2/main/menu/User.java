...
public class User 
{
	...
	public void registerUser() // menubar register
	{
		...
		try{
			writer = new PrintWriter(new FileWriter(UserInfo, true));// true meand append mode
		...
		//  Example of writing to file format
		//  Username Password Score
		//	Alper 123 999
		
	}
	public int loginUser() // no parameter login for menubar
	{
